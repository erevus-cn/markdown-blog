	...
	<div class="container">	
		<div class="row">					    
		    <div class="col-md-10 col-md-offset-1">
		    	<h1><?php echo ($post["title"]); ?></h1><p>[<?php echo ($post["author"]); ?>]</p>
		    	<hr/>
		    ...
		    <p>
		    	<?php if((empty($before))): ?><span>没有了</span>
		    		<?php else: ?> <a href="__URL__/Index/view/id/<?php echo ($before['id']); ?>">上一篇</a><?php endif; ?>
		    	<?php if((empty($after))): ?><span>没有了</span>
		    		<?php else: ?> <a href="__URL__/Index/view/id/<?php echo ($after['id']); ?>">下一篇</a><?php endif; ?>
		    </p>
		    </div>
		</div>
	</div>
